...
Sometimes, you promote or demote an admin manually, and Bhanumathi doesn't realise it immediately. This is because to avoid spamming telegram servers, admin status is cached locally.
...
that'll force Bhanumathi to check who the admins are again. 
"""
